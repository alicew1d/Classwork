...
public class MovingRotorTest {
    ...
    public void checkRotorAdvance() {
        ...
        Rotor r = new MovingRotor("I", p, "NP");
        r.advance();
        r.advance();
    ...
    public void checkAtNotch() {
        ...
        Permutation p = new Permutation(cycle,
                new Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
        Rotor r = new MovingRotor("I", p, "AC");
        assertEquals(true, r.atNotch());
        r.advance();
        r.advance();
        assertEquals(true, r.atNotch());
    }
    ...
    public void checkconvertForward() {
        ...
        Permutation p = new Permutation(cycle,
                new Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
        Rotor r = new MovingRotor("I", p, "JK");
        r.advance();
        r.advance();
        r.advance();
        assertEquals(2, r.convertForward(0));
        r.set(24);
        assertEquals(4, r.convertForward(0));
    }
    ...
    public void checkconvertBackward() {
        ...
        r.advance();
        r.advance();
        assertEquals(3, r.convertBackward(0));
        r.set(24);
        assertEquals(16, r.convertBackward(0));
    }
}
