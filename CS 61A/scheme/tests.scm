...
(let ((x 4) (y 6)) (define (addthem a b) (+ a b)) (addthem x y)) 
; expect 10 
...
; edge cases: do we evaluate expression in define special form more than one?
; do we check to see if operator is a procedure before evaluating operand 
; do some quote, quasiquote, and unquote tests
