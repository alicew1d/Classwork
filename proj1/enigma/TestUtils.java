...
class  TestUtils {
    ...
    static String cycleI = "(AELTPHQXRU) (BKNW) (CMOY) (DFG) (IV) (JZ) (S)";
    static String cycleIII = "(ABDHPEJT) (CFLVMZOYQIRWUKXSG) (N)";
    static String cycleIV = "(AEPLIYWCOXMRFZBSTGJQNH) (DV) (KU)";
    static String sbeta = "(ALBEVFCYODJWUGNMQTZSKPR) (HIX)";
    static String sB = "(AE) (BN) (CK) (DQ) (FU) (GY) (HW) (IJ) (LO) "
            + "(MP) (RX) (SZ) (TV)";
    static Alphabet alphabet1 = new Alphabet(alphabet);
    static Permutation permI = new Permutation(cycleI, alphabet1);
    static Permutation permIII = new Permutation(cycleIII, alphabet1);
    static Permutation permIV = new Permutation(cycleIV, alphabet1);
    static Permutation permBeta = new Permutation(sbeta, alphabet1);
    static Permutation permB = new Permutation(sB, alphabet1);
    static Rotor rI = new MovingRotor("I", permI, "Q");
    static Rotor r3 = new MovingRotor("III", permIII, "E");
    static Rotor r4 = new MovingRotor("IV", permIV, "V");
    static Rotor beta = new FixedRotor("Beta", permBeta);
    static Rotor b = new Reflector("B", permB);
